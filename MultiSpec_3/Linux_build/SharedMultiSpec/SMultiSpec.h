...
#pragma once
	...
	#ifdef multispec_basic_win
		#define include_hdf_capability 0 
		#define include_gdal_capability 0
		#define include_hdf5_capability 0
	#else
		#define include_hdf_capability 0    //1 (original)
		#define include_gdal_capability 0   //1 (original)
		#define include_hdf5_capability 0   //1 (original)
	#endif
